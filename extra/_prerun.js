...
const permittedPanels = ["application", "console", "developer_resources", "elements", "mobile_throttling", "network", "protocol_monitor", "settings", "sources", "emulation", "screencast"];
